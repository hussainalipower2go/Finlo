          ...
          <div className="finlo-features">
            {[
              ...
              <div key={i} className="finlo-feature" style={{
                ...
                padding: "14px 16px", borderRadius: 16, minWidth: 0,
                background: "rgba(255,255,255,0.28)",
                border: "1px solid rgba(255,255,255,0.7)",
                backdropFilter: "blur(20px) saturate(160%)",
                WebkitBackdropFilter: "blur(20px) saturate(160%)",
                boxShadow: "0 12px 30px rgba(10,25,61,0.14), inset 0 1px 0 rgba(255,255,255,0.9)",
              }}>
        ...
        <div className="finlo-card" style={{
          ...
          <div style={{ marginBottom: "20px" }}>
            ...
            <div style={{ position: "relative" }}>
              ...
              <input id="signup-email" type="email" value={email} autoComplete="email"
          ...
          <div style={{ marginBottom: "20px" }}>
            ...
            <div style={{ position: "relative" }}>
              ...
              <input id="signup-password" type={showPassword ? "text" : "password"} value={password} autoComplete="new-password"
          ...
          <div style={{ marginBottom: "16px" }}>
            ...
            <div style={{ position: "relative" }}>
              ...
              <input id="signup-confirm" type={showConfirmPassword ? "text" : "password"} value={confirmPassword} autoComplete="new-password"
                onChange={e => { setConfirmPassword(e.target.value); if (error) setError(""); }} placeholder="Re-enter your password"
                style={{ width: "100%", padding: "14px 48px 14px 44px", background: p.inputBg, border: `1px solid ${p.line}`, borderRadius: "12px", fontSize: "14px", color: p.inputText, outline: "none", fontFamily: "inherit", boxSizing: "border-box" }}
                onFocus={e => e.target.style.borderColor = "rgba(10,25,61,0.55)"}
                onBlur={e => e.target.style.borderColor = p.line}
              />
          ...
          <div style={{ display: "flex", alignItems: "center", marginBottom: "20px" }}>
            <label style={{ display: "flex", alignItems: "center", gap: "9px", cursor: "pointer" }}>
              <div onClick={() => setAgreeTerms(!agreeTerms)} style={{ width: "18px", height: "18px", borderRadius: "5px", flexShrink: 0, background: agreeTerms ? "#0A193D" : "rgba(10,25,61,0.08)", border: agreeTerms ? "none" : `1px solid ${p.line}`, display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer" }}>
