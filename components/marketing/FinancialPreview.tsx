  ...
  return (
    <div className="relative w-full max-w-[460px]">
      <div
        ...
        style={{
          background: 'radial-gradient(ellipse, rgba(20,36,83,0.5) 0%, transparent 70%)',
          filter: 'blur(20px)',
        }}
      />
      ...
      <div
        ...
        style={{
          ...
          border: '1px solid rgba(10,25,61,0.3)',
      ...
      >
        <div
          ...
          style={{ background: 'rgba(8,6,22,0.85)', border: '1px solid rgba(10,25,61,0.22)' }}
        >
          ...
          <div className="mb-3 text-[10px] leading-[1.4] text-[#0A193D]/50">Estimated amount you can spend today</div>
        ...
        <div
          ...
          style={{ background: 'rgba(8,6,22,0.85)', border: '1px solid rgba(10,25,61,0.22)' }}
        >
          <div className="mb-1.5 text-[10.5px] font-semibold tracking-[0.3px] text-[#0A193D]">Money Runway</div>
          <div className="mb-1 text-[26px] font-bold text-white">17 days</div>
          <div className="mb-2 text-[10px] leading-[1.4] text-[#0A193D]/50">Estimated days your money will last</div>
        ...
        <div
          ...
          style={{
            ...
            boxShadow: '0 0 32px rgba(10,25,61,0.7), 0 0 64px rgba(79,70,229,0.35)',
          }}
        >
          ₹
        </div>
