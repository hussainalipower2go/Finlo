...
export function LoginForm({ className = '' }: { className?: string }) {
  ...
  return (
    ...
    >
      ...
      <p className="mb-8 text-sm text-[#9482c8]/60">Login to continue to your account</p>
      ...
      <form onSubmit={handleSubmit} noValidate>
        ...
        <div className="mb-6 flex items-center justify-between">
          ...
          >
            <span
              ...
              style={{
                background: rememberMe ? '#7c3aed' : 'rgba(109,40,217,0.12)',
                border: rememberMe ? 'none' : '1px solid rgba(109,40,217,0.3)',
              }}
            >
              {rememberMe && (
            ...
            <span className="text-[13px] text-[#c4b5fd]/75">Remember me</span>
          </button>
          <Link href="/auth/forgot-password" className="text-[13px] text-[#8b5cf6] no-underline transition-colors hover:text-[#7c3aed]">
            Forgot password?
          </Link>
        </div>
        ...
        <p className="text-center text-sm text-[#826eb4]/60">
          ...
          <Link href="/auth/signup" className="font-medium text-[#8b5cf6] no-underline transition-colors hover:text-[#7c3aed]">
            Sign up
          </Link>
        </p>
      </form>
