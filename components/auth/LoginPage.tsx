          ...
          <div className="finlo-card" style={{
            ...
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "24px" }}>
              <label style={{ display: "flex", alignItems: "center", gap: "9px", cursor: "pointer" }}>
                <div onClick={() => setRememberMe(!rememberMe)} style={{ width: "18px", height: "18px", borderRadius: "5px", flexShrink: 0, background: rememberMe ? "#7c3aed" : (isDark ? "rgba(109,40,217,0.12)" : "rgba(109,40,217,0.08)"), border: rememberMe ? "none" : `1px solid ${p.line}`, display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer" }}>
              ...
              <Link href="/auth/forgot-password" style={{ fontSize: "13px", color: "#8b5cf6", textDecoration: "none" }}>Forgot password?</Link>
            </div>
            ...
            <div style={{ textAlign: "center", fontSize: "14px", color: p.desc }}>
              ...
              <Link href="/auth/signup" style={{ color: "#8b5cf6", textDecoration: "none", fontWeight: 500 }}>Sign up</Link>
            </div>
          </div>
        </div>
