          ...
          <div className="finlo-card" style={{
            ...
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "24px" }}>
              <label style={{ display: "flex", alignItems: "center", gap: "9px", cursor: "pointer" }}>
                <div onClick={() => setRememberMe(!rememberMe)} style={{ width: "18px", height: "18px", borderRadius: "5px", flexShrink: 0, background: rememberMe ? "#0A193D" : (isDark ? "rgba(10,25,61,0.12)" : "rgba(10,25,61,0.08)"), border: rememberMe ? "none" : `1px solid ${p.line}`, display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer" }}>
